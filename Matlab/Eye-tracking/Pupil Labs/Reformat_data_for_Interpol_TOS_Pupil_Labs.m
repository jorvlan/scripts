...
for index=1:length(subjects)
    ...
    stimOnsets=find(diff(TOS_left_eye_df(:,6)>"1")>0)+1; %If you do not want to include the shock trial on/offsets, then replace "1" with "69"
    ...
    %Block 1
TOS_left_eye_df(stimOnsets(1,1):stimOnsets(2,1),6) = '80';
TOS_left_eye_df(stimOnsets(3,1):stimOnsets(4,1),6) = '71';
TOS_left_eye_df(stimOnsets(5,1):stimOnsets(6,1),6) = '81';
TOS_left_eye_df(stimOnsets(7,1):stimOnsets(8,1),6) = '70';
    %Block 2
TOS_left_eye_df(stimOnsets(9,1):stimOnsets(10,1),6) = '128';
TOS_left_eye_df(stimOnsets(11,1):stimOnsets(12,1),6) = '71';
TOS_left_eye_df(stimOnsets(13,1):stimOnsets(14,1),6) = '80';
TOS_left_eye_df(stimOnsets(15,1):stimOnsets(16,1),6) = '81';
TOS_left_eye_df(stimOnsets(17,1):stimOnsets(18,1),6) = '70';
    %Block 3
TOS_left_eye_df(stimOnsets(19,1):stimOnsets(20,1),6) = '70';
TOS_left_eye_df(stimOnsets(21,1):stimOnsets(22,1),6) = '81';
TOS_left_eye_df(stimOnsets(23,1):stimOnsets(24,1),6) = '80';
TOS_left_eye_df(stimOnsets(25,1):stimOnsets(26,1),6) = '71';
    %Block 4
TOS_left_eye_df(stimOnsets(27,1):stimOnsets(28,1),6) = '81';
TOS_left_eye_df(stimOnsets(29,1):stimOnsets(30,1),6) = '70';
TOS_left_eye_df(stimOnsets(31,1):stimOnsets(32,1),6) = '80';
TOS_left_eye_df(stimOnsets(33,1):stimOnsets(34,1),6) = '71';
