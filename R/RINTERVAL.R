...
#Extra info about whats what in the code:
  
#data = the data frame
#id = the ID variable
#datetime = The date/time variable in date_time format, if its not in this format you can use lubridate::as_datetime(date/time variable) first
#min.int = the minimum interval in minutes. If the minimum interval in the supplied data is shorter than that minimum interval, it is not a problem
#no.night = if true does not impute for the night hours (between days)
